...
//using CalibrationSaaS.Store.State;
...
namespace Blazed.Controls
{
   ...
   // }
    ...
    public abstract class ControlComponentBase : ComponentBase
    { 
        ...
        public async Task ExceptionManager(RpcException rpcException)
        {
            ...
            //Console.WriteLine("error rpc: " + Error );
        ...
        public async Task ExceptionManager(Exception rpcException)
        {
            ...
            Error = rpcException.Message;
            Console.WriteLine("error :" + rpcException.Message);
            //if (MessageTmp == Error)
            //{
            //    return;
            //}
        ...
        public async Task CloseProgress()
        {
         ...
         public async Task IniCoordControl()
        {
           
            if (JSRuntime != null)
            {
               
                await JSRuntime.InvokeVoidAsync("inicoordcontrol");
            }
...
#pragma warning restore CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        ...
        public async Task<bool> IsInPolicy(Policies policy, Helpers.Controls.Component component)
        {
            ...
            if(AuthorizationService != null)
            {
                ...
                if (ed != null && ed.Failure != null && ed.Failure.FailCalled)
                {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (Services.GetService<IAuthorizationService>() is { } au)
            {
                AuthorizationService = au;
            }

            if (Services.GetService<IJSRuntime>() is { } JS)
            {
                JSRuntime = JS;
            }
    ...
    //public abstract class KavokuComponentBase<T> : ControlComponentBase
    //{
