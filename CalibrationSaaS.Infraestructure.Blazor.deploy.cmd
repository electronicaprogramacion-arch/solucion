...
set _DeploySetParametersFile=%RootPath%CalibrationSaaS.Infraestructure.Blazor.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%CalibrationSaaS.Infraestructure.Blazor.zip" (
echo "%RootPath%CalibrationSaaS.Infraestructure.Blazor.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%CalibrationSaaS.Infraestructure.Blazor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%CalibrationSaaS.Infraestructure.Blazor.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%CalibrationSaaS.Infraestructure.Blazor.deploy-readme.txt" (
...
start notepad "%RootPath%CalibrationSaaS.Infraestructure.Blazor.deploy-readme.txt"
)
echo =========================================================
goto :eof
