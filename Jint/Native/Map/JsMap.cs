...
internal sealed class JsMap : ObjectInstance
{
    ...
    internal readonly Jint.Runtime.OrderedDictionary<JsValue, JsValue> _map;

    public JsMap(Engine engine, Realm realm) : base(engine)
    {
        _realm = realm;
        _map = new Jint.Runtime.OrderedDictionary<JsValue, JsValue>(SameValueZeroComparer.Instance);
    }
