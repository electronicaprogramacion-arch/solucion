...
{
    public class CustomerServiceOffline : Application.Services.ICustomerService<CallContext>
    {
        ...
        public CustomerServiceOffline(dynamic dbFactory)
        {
        ...
        public ValueTask<ResultSet<Contact>> GetContactsByCustomID(string customID, Pagination<Contact> pagination, CallContext context)
        {
            throw new NotImplementedException();
        }

        public ValueTask<ResultSet<Contact>> GetContactsByCustomID(Customer customer, Pagination<Contact> pagination, CallContext context)
        {
           
            var emptyResult = new ResultSet<Contact>
            {
            ...
            return new ValueTask<ResultSet<Contact>>(emptyResult);
        }
        ...
        public async ValueTask<ResultSet<Customer>> GetCustomers(Pagination<Customer> Pagination, CallContext context)
        {
            ...
            using (var db = await this.DbFactory.Create<CalibrationSaaSOfflineDB>())
            {
                ...
                var result = await queriable.PaginationAndFilterQueryOff<Customer>(Pagination, simplequery, filterQuery);
        ...
        public ValueTask<Customer> GetCustomersByID(Customer customerDTO, CallContext context)
        {
            throw new NotImplementedException();
        }
