...
namespace BlazorApp1.Blazor.Blazor
{
    public class DynamicReportBase
        : Base_Create<WorkOrderDetail, Func<dynamic, CalibrationSaaS.Application.Services.IWorkOrderDetailServices<CallContext>>, CalibrationSaaS.Domain.Aggregates.Shared.Basic.AppState>
    //, IPage<WorkOrderDetail, IWorkOrderDetailServices, Domain.Aggregates.Shared.AppStateCompany>
    {
        ...
        public async Task<bool> Delete(CalibrationSaaS.Domain.Aggregates.Entities.WorkOrderDetail DTO)
        {
            try
            {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            eq.CurrentStatus = new CalibrationSaaS.Domain.Aggregates.Entities.Status();

            eq.PieceOfEquipment.Customer = new CalibrationSaaS.Domain.Aggregates.Entities.Customer();

            eq.TestCode = new TestCode();

            eq.WorkOder = new CalibrationSaaS.Domain.Aggregates.Entities.WorkOrder();
