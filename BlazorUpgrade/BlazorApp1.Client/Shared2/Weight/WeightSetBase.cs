...
using IWorkOrderItemCreate = BlazorApp1.Blazor.Blazor.Pages.Order.IWorkOrderItemCreate;
...
namespace BlazorApp1.Blazor.Blazor.Shared
{
    public class WeightSetComponentBase : KavokuComponentBase<WeightSet>
    {
        ...
        public async Task SelectWeightSet()
        {
            ...
            //var messageForm = Modal.Show<BlazorApp1.Blazor.Blazor.GenericMethods.POEWeightSet_Select>("Select Standard", parameters, op);
            ...
            var _listPoEDueDates = await OpenOrder(parameters);
        ...
        public async Task<List<PieceOfEquipment>> OpenOrder(Dictionary<string, object> parameters)
        {
            ...
            var result= await DialogService.OpenAsync<BlazorApp1.Blazor.Blazor.GenericMethods.POEWeightSet_Select>("Select",
                   parameters,
                   new DialogOptions()
                   {
                       Resizable = true,
        ...
        private async Task LoadStateAsync()
        {
            ...
            var result = await JSRuntime.InvokeAsync<string>("window.localStorage.getItem", "DialogSettings_W");
        ...
        private async Task SaveStateAsync()
        {
            ...
            await JSRuntime.InvokeVoidAsync("window.localStorage.setItem", "DialogSettings_W", JsonSerializer.Serialize<DialogSettings>(Settings));
        }
