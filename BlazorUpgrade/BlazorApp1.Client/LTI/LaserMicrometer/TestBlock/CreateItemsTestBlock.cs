...
{
    public class Create : ComponentBase, ICreateItems<PieceOfEquipment,GenericCalibration2>
    {
        ...
        private static List<GenericCalibrationResult2> NewMethod(PieceOfEquipment eq,int CalibrationSubTypeId)
        {
            ...
            gce.StandardNominal = 0;
            gce.CalibratedDiameterAverage = 0;
            gce.RepeteabilityTest = false;
