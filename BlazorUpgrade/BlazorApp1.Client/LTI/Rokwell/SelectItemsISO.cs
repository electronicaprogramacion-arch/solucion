...
{
    public class SelectItemsAsLeftISO : ComponentBase, ISelectItems
    {
        ...
        public async Task StandardTask(WorkOrderDetail eq, WeightSetResult r, List<PieceOfEquipment> resultado, GenericCalibration itemParent,List<GenericCalibration> Items, int position)
        {
            ...
            dynamic item = Newtonsoft.Json.JsonConvert.DeserializeObject<dynamic>(itemParent.BasicCalibrationResult.Object);


            //dynamic item = null;

            item.Nominal = CalResult;
            ...
            if (WeightSetList?.Count > 0)
            {
                ...
                else
                {
                    ...
                    item.Tolerance = poeselect.Tolerance.ToleranceValue;
                }
                ...
                item.Uncertanty = poeselect.UncertaintyValue;
            ...
            itemParent.BasicCalibrationResult.Object = json;
        ...
        public async Task<SelectList> SelectItems(WorkOrderDetail eq, int CalibrationSubTypeId, GenericCalibration item, int Position)
        {
            ...
            var json = item.BasicCalibrationResult.Object;
            ...
            SelectList.Result = resultado.ToList();
