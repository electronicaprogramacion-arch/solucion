...
namespace BlazorApp1.CacheStorage.Utils;
...
public class CacheStorageAccessor : IAsyncDisposable
{
    ...
    public async Task RemoveByUrlAsync(string urlsource)
    {
        await WaitForReference();
        await _accessorJsRef.Value.InvokeVoidAsync("removeByUrl", urlsource);
    }
