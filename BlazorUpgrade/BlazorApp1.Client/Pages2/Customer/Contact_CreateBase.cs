...
namespace BlazorApp1.Blazor.Pages.Customer
{
    public class Contact_CreateBase
        : Base_Create<Contact, ICustomerService<CallContext>, CalibrationSaaS.Domain.Aggregates.Shared.AppStateCompany>
    //, IPage<Contact, ICustomerService<CallContext>, Domain.Aggregates.Shared.AppStateCompany>
    {
        ...
        public async Task<bool> Delete(CalibrationSaaS.Domain.Aggregates.Entities.Contact DTO)
        {
