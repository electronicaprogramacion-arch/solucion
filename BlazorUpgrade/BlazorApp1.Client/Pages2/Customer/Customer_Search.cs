...
{
    public class Customer_SearchBase : Base_Create<CalibrationSaaS.Domain.Aggregates.Entities.Customer, Func<dynamic, ICustomerService<CallContext>>, CalibrationSaaS.Domain.Aggregates.Shared.AppStateCompany>
    //ComponentBase, 
 ...
 [Inject]
        ...
        public Microsoft.AspNetCore.Components.Authorization.AuthorizeRouteView Authorized { get; set; }

        public ClaimsPrincipal CurrentUser { get; set; }


        public ResponsiveTable<CalibrationSaaS.Domain.Aggregates.Entities.Customer> Grid { get; set; } = new ResponsiveTable<CalibrationSaaS.Domain.Aggregates.Entities.Customer>();


        //[Inject]
        //AuthenticationStateProvider AuthenticationStateProvider { get; set; }

        public List<CalibrationSaaS.Domain.Aggregates.Entities.Customer> ListCustomer = new List<CalibrationSaaS.Domain.Aggregates.Entities.Customer>();
        ...
        public override async Task<ResultSet<CalibrationSaaS.Domain.Aggregates.Entities.Customer>> LoadData(Pagination<CalibrationSaaS.Domain.Aggregates.Entities.Customer> pag)
        {
           
            //var token = await CustomCallOptions.GetCustomToken();
            //var g = await CustomCallOptions.GetCustomCallOptions(token);
            //AppSecurity.Token = token;
...
#pragma warning restore CS0108 // 'Customer_SearchBase.Dispose()' oculta el miembro heredado 'Base_Create<Customer, ICustomerService<CallContext>, AppStateCompany>.Dispose()'. Use la palabra clave new si su intención era ocultarlo.
        ...
        public async Task<bool> Delete(CalibrationSaaS.Domain.Aggregates.Entities.Customer DTO)
        {
...
#pragma warning disable CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        public async Task SelectModal(CalibrationSaaS.Domain.Aggregates.Entities.Customer DTO)
