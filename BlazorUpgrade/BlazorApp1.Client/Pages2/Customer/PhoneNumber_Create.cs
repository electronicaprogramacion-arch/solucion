...
namespace BlazorApp1.Blazor.Pages.Customer
{
    public class PhoneNumbers_CreateBase
        : Base_Create<PhoneNumber, Func<dynamic, CalibrationSaaS.Application.Services.ICustomerService<CallContext>>, CalibrationSaaS.Domain.Aggregates.Shared.AppStateCompany>

    {
        ...
        public async Task<bool> Delete(CalibrationSaaS.Domain.Aggregates.Entities.PhoneNumber DTO)
        {
            try
            {
