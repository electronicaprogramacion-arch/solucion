...
{
    public class CalibrationInstructionsLTIBase : CalibrationInstructionsBase_, BlazorApp1.Blazor.Blazor.ICalibrationInstructionsLTIBase
    {
...
#pragma warning restore CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        ...
        public BlazorApp1.Blazor.Pages.Basics.TestPoints.RangeTestPoint RangeComponent { get; set; }

        public BlazorApp1.Blazor.Pages.Basics.TestPoints.RangeTestPoint RangeAccuracy { get; set; }
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        [Inject]
        public Func<dynamic, CalibrationSaaS.Application.Services.IBasicsServices<CallContext>> Service { get; set; }
...
#pragma warning restore CS0168 // La variable 'ex' se ha declarado pero nunca se usa
        ...
        [Inject]
        public Func<dynamic, CalibrationSaaS.Application.Services.IAssetsServices<CallContext>> Client { get; set; }
