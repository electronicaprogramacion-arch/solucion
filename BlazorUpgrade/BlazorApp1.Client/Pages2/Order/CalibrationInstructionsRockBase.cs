...
using CalibrationSaaS.Application;
...
{
    public class CalibrationInstructionsRockBase : BlazorApp1.Blazor.Shared.CalibrationInstructionsBase_, BlazorApp1.Blazor.Blazor.ICalibrationInstructionsLTIBase
    {
