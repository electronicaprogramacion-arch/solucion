...
{
    public class POEChildren_SearchBase : Base_Create<PieceOfEquipment, Func<dynamic, CalibrationSaaS.Application.Services.IPieceOfEquipmentService<CallContext>>, CalibrationSaaS.Domain.Aggregates.Shared.Basic.AppState>
