...
{
    public class POEIndicator_SearchBase : Base_Create<PieceOfEquipment, CalibrationSaaS.Application.Services.IPieceOfEquipmentService<CallContext>, CalibrationSaaS.Domain.Aggregates.Shared.AppStateCompany>
