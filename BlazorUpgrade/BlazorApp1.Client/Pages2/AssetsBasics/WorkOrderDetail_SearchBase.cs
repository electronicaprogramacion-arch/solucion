...
{
    public class WorkOrderDetail_SearchBase
        : Base_Create<WorkOrderDetail,Func<dynamic, IWorkOrderDetailServices<CallContext>>, CalibrationSaaS.Domain.Aggregates.Shared.AppStateCompany>
    //, IPage<WorkOrderDetail, IWorkOrderDetailServices, Domain.Aggregates.Shared.AppStateCompany>
    {
        ...
        [CascadingParameter]
        public BlazorApp1.Blazor.Pages.AssetsBasics.WorkOrder_Create WorkOrder_Create { get; set; }
