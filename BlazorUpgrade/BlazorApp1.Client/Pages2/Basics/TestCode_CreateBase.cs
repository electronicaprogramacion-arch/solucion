...
{
    public class TestCode_CreateBase : Base_Create<TestCode, CalibrationSaaS.Application.Services.IWorkOrderDetailServices<CallContext>,
        CalibrationSaaS.Domain.Aggregates.Shared.Basic.AppState>
    {
        ...
        [Inject] CalibrationSaaS.Application.Services.IWorkOrderDetailServices<CallContext> _wod { get; set; }
        public List<CalibrationSubType> _calibrationSubtypeList = new List<CalibrationSubType>();
        [Inject] public CalibrationSaaS.Application.Services.IBasicsServices<CallContext> _basicsServices { get; set; }
