...
{
    public class NewDefaultValue : ComponentBase, INewItem<PieceOfEquipment,GenericCalibration2>
    {
        ...
        public async Task<List<GenericCalibration2>> DefaultNewItem(PieceOfEquipment eq, int CalibrationSubTypeId)
        {
            ...
            gcr.CreateNew(res.Count +1, CalibrationSubTypeId,
                          Parameter?.Component != null ? Parameter?.Component : "PieceOfEquipmentCreate", eq.ComponentID,eq.Resolution,Parameter.DefaultData);
