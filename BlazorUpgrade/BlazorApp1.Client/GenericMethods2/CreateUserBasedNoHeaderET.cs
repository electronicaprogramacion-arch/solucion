...
{
    public class CreateUserBasedNoHeaderET : ComponentBase, ICreateItems<EquipmentTemplate, GenericCalibration2>
    {
...

        {
            ...
            for (int i = 0; i < Convert.ToInt32(Parameter.NumberTestpoints); i++)
            {
                ...
                gcr.CreateNew(cont, CalibrationSubTypeId, "EquipmentTemplate", eq.EquipmentTemplateID.ToString(), eq.Resolution, gce);
