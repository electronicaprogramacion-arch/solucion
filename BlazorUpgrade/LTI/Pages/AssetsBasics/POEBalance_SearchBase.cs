...
{
    public class POEBalance_SearchBase : Base_Create<PieceOfEquipment, Func<dynamic, Application.Services.IPieceOfEquipmentService<CallContext>>, Domain.Aggregates.Shared.AppStateCompany>
    ...
    //Application.Services.IBasicsServices, Domain.Aggregates.Shared.Basic.AppState>
    {
        ...
        public override async Task<ResultSet<PieceOfEquipment>> LoadData(Pagination<PieceOfEquipment> pag)
        {
            ...
            poe.IndicatorPieceOfEquipmentID = IndicatorID;
            ...
            Eq = (await _poeGrpc.GetPieceOfEquipmentBalanceByIndicator(pag));
...
#pragma warning disable CS0108 // 'POEBalance_SearchBase.Dispose()' oculta el miembro heredado 'Base_Create<PieceOfEquipment, IPieceOfEquipmentService<CallContext>, AppStateCompany>.Dispose()'. Use la palabra clave new si su intención era ocultarlo.
        public void Dispose()
#pragma warning restore CS0108 // 'POEBalance_SearchBase.Dispose()' oculta el miembro heredado 'Base_Create<PieceOfEquipment, IPieceOfEquipmentService<CallContext>, AppStateCompany>.Dispose()'. Use la palabra clave new si su intención era ocultarlo.
        {
