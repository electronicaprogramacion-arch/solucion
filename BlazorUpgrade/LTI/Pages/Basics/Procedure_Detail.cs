...
{
    public class Procedure_DetailBase : ComponentBase
    {
        ...
        public CalibrationSaaS.Domain.Aggregates.Entities.Procedure eq = new CalibrationSaaS.Domain.Aggregates.Entities.Procedure();
        protected string _Disable = "disabled";
#pragma warning disable CS0414 // El campo 'Procedure_DetailBase.formInvalid' está asignado pero su valor nunca se usa
        private bool formInvalid = true;
#pragma warning restore CS0414 // El campo 'Procedure_DetailBase.formInvalid' está asignado pero su valor nunca se usa
