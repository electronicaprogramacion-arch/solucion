...
{
    public class SelectWODStandardBase : Base_Create<PieceOfEquipment,
        Func<dynamic, Application.Services.IPieceOfEquipmentService<CallContext>>,
    ...
    //Application.Services.IBasicsServices, Domain.Aggregates.Shared.Basic.AppState>
    {
        ...
        //    result.ColumnName = "DueDate";
        //    result.ClientPagination = true;

        //    //Grid.ItemsDataSource = Eq.PieceOfEquipments;
