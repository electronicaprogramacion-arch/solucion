...
#pragma warning restore CS0414 // El campo 'LinearityComponentBase.WeightSetListCount' está asignado pero su valor nunca se usa
        ...
        public Tolerance SetTolerancePerTestPoint(string jsonTolerancePerTestPoint)
        {
            ...
            //tol.ToleranceTypeID = WorkOrderItemCreate.Tolerance.ToleranceTypeID.Value;
            //    tol.AccuracyPercentage = WorkOrderItemCreate.AccuracyPercentage;

            //    tol = WorkOrderItemCreate.Tolerance;

            //    tol.ResolutionValue = WorkOrderItemCreate.Resolution;
            //    tol.ToleranceFixedValue = WorkOrderItemCreate.ToleranceFixedValue;
            //    tol.DecimalNumber = WorkOrderItemCreate.DecimalNumber;
            //    tol.Resolution = WorkOrderItemCreate.Resolution;

            //    tol.MaxValue = GetMaxValue();
            ...
            try
           {
                ...
                if (_strGet != null)
                {
                    var inheritCalSubType = CalSubType.inheritCalibrationSubTypeId;
                     ...
                     getreturn = await _strGet.GetItems(WorkOrderItemCreate, IsCompresion, inheritCalSubType);
        ...
        ///YPPP
        ///
        //public async Task<string> ShowModalAsync()
        //{
        //    var result = ModalHandler.ShowModalAsync();
