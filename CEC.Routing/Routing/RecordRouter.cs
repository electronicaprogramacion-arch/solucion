...
namespace CEC.Routing.Router
{
    ...
    public class RecordRouter : IComponent, IHandleAfterRender, IDisposable
    {
        ...
        [Inject] AppStateCompany AppState { get; set; }
...
//            Console.WriteLine(routeurl);
            ...
            //AppState.SetHistory(routeurl, null,"admin");

            //foreach(var item in AppState.HistoryNavigte)
            //{

            //    Console.WriteLine(item.Route,"datossss");
            ...
            RouterSessionService.LastRouteUrl = this.NavigationManager.Uri;
