...
namespace SqliteWasmHelper
{
        ...
        where TContext : DbContext
    {
        ...
        /// this method.
        /// </summary>
        /// <param name="ctx">ffff</param>
        /// <returns>nothing</returns>
        public async Task MakeBackup(TContext ctx)
        {
//            Console.WriteLine("Ctx_SavedChanges 1");
            await ctx.Database.CloseConnectionAsync();
            await CheckForStartupTaskAsync();
//            Console.WriteLine("Ctx_SavedChanges 2");
            ...
            ForceUpdate = false;
//            Console.WriteLine("lastStatus: force2 " + lastStatus);
        }
