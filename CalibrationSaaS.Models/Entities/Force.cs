...
{
    [DataContract]
    public partial class Force : ICalibrationSubType
    {      
        ...
        [Required(ErrorMessage = "Required")]
        [DataMember(Order = 6)]      
        public virtual ForceResult BasicCalibrationResult { get; set; }
        ...
        [NotMapped]
        public ICollection<CalibrationSubType_Standard> Standards { get ; set ; }
    }
}
