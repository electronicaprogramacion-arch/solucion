...
namespace CalibrationSaaS.Infraestructure.Blazor
{
    public interface ICalibrationInstructionsLTIBase
    {
        ...
        RangeTestPoint RangeAccuracy { get; set; }
        RangeTestPoint RangeComponent { get; set; }
        Func<Task> RefreshParent { get; set; }
        ResolutionComponent ResolutionComponent { get; set; }
        ...
        IWorkOrderItemCreate WorkOrderItemCreate { get; set; }
