...
namespace CalibrationSaaS.Infraestructure.Blazor.LTI.Rockwell
{
    public class Scales_CreateBase
        : Base_Create<POE_Scale, IPieceOfEquipmentService<CallContext>, Domain.Aggregates.Shared.AppStateCompany>
    ...
    public bool IsForAccredited { get; set; } = false;
        ...
        public async Task<bool> Delete(Domain.Aggregates.Entities.POE_Scale DTO)
        {
