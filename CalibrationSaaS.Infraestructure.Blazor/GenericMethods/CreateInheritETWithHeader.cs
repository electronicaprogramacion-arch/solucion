...
{
    public class CreateInheritETWithHeader : CreateBase<PieceOfEquipment, GenericCalibration2, GenericCalibrationResult2>, ICreateItems<PieceOfEquipment, GenericCalibration2>//ComponentBase, ICreateItems<PieceOfEquipment,Generic
    {
