...
#pragma warning disable CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        ...
        public async Task<string> ShowModal(IModalService _modalService, string jsonTolerancePerTestPoint)
        {
            ...
            var messageForm = _modalService.Show<CalibrationSaaS.Infraestructure.Blazor.Pages.Basics.ResolutionComponentModal>("Tolerance per Test Point", parameters, op);
            var result = await messageForm.Result;
        ...
        /// <summary>
        /// Creates a dictionary structure by grouping items and extracting key-value pairs using reflection.
        /// Calls a method from AppState to get the list of items.
        /// When groupingPropertyName is null, returns Dictionary&lt;string, string&gt;.
        ...
        /// <param name="groupingPropertyName">The name of the property that will be used for grouping (null for flat dictionary)</param>
            ...
            params object[] methodParameters)
        {
            ...
            if (listResult == null)
            {
                // Return appropriate empty dictionary based on grouping parameter
                return string.IsNullOrEmpty(groupingPropertyName)
            ...
            // If groupingPropertyName is null, return a flat Dictionary<string, string>
            if (string.IsNullOrEmpty(groupingPropertyName))
            {
                ...
                foreach (var item in items)
                {
                    ...
                    // Note: If duplicate keys exist, the last one will overwrite previous ones
                    flatResult[keyValue] = valueValue;
                }

                return flatResult;
            }

            // Otherwise, create nested dictionary with grouping
        ...
        /// <summary>
        /// Creates a dictionary structure by extracting key-value pairs using reflection.
        /// When groupingPropertyName is null, returns Dictionary&lt;string, string&gt;.
        /// When groupingPropertyName is provided, returns Dictionary&lt;string, Dictionary&lt;string, string&gt;&gt;.
        /// </summary>
