...
{
    public class EquipmentTemplate_SearchBase : Base_Create<EquipmentTemplate, Func<dynamic, Application.Services.IBasicsServices<CallContext>>, Domain.Aggregates.Shared.Basic.AppState>
