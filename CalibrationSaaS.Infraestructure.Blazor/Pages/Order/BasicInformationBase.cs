...
#pragma warning restore CS0108 // 'BasicInformationBase.NavigationManager' oculta el miembro heredado 'KavokuComponentBase<WorkOrderDetail>.NavigationManager'. Use la palabra clave new si su intención era ocultarlo.
        ...
        [Inject]
        public Func<dynamic, Application.Services.IPieceOfEquipmentService<CallContext>> _poeServices { get; set; }


        [CascadingParameter] public IModalService Modal { get; set; }

        [Parameter]
        public Domain.Aggregates.Entities.Status CurrentStatus { get; set; }
        ...
        async Task ShowEquipment()
        {
            ...
            var messageForm = Modal.Show<Equipment_Create>("Equipment Template", parameters);
            var result = await messageForm.Result;
        ...
        async Task ShowEquipmentType()
        {
            ...
            var messageForm = Modal.Show<Equipment_Search>("Select Equipment Template", parameters);
            var result = await messageForm.Result;
        ...
        async Task ShowCustomer()
        {
            ...
            var messageForm = Modal.Show<Customer_Search>("Select a Customer", parameters, op);
            var result = await messageForm.Result;
...
#pragma warning restore CS1998 // El método asincrónico carece de operadores "await" y se ejecutará de forma sincrónica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        ...
        public async Task ShowModalPoEIndicator()
        {
            ...
            if (result != null)
            {
                ...
                //var res = (List<PieceOfEquipment>)result.Data;
