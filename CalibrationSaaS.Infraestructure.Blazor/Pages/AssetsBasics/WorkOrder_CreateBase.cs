...
{
    public class WorkOrder_CreateBase : Base_Create<WorkOrder, Func<dynamic, Application.Services.IAssetsServices<CallContext>>, Domain.Aggregates.Shared.AppStateCompany>
    {


         [Inject] 
        public Func<dynamic, Application.Services.IWorkOrderDetailServices<CallContext>> WODServices { get; set; }
        ...
        [Inject] Application.Services.ICustomerService<CallContext> _customerService { get; set; }
        //[Inject] public Application.Services.ICompanyServices _companyService { get; set; }
        //[Inject] public Application.Services.IWorkOrderDetailServices<CallContext> _workOrderDetailService { get; set; } 
...
#pragma warning restore CS0108 // 'WorkOrder_CreateBase.Logger' oculta el miembro heredado 'KavokuComponentBase<WorkOrder>.Logger'. Use la palabra clave new si su intenci�n era ocultarlo.
        ...
        //[Inject] Application.Services.IPieceOfEquipmentService<CallContext> _pieceOfEquipmentService { get; set; }
        ...
        public Domain.Aggregates.ValueObjects.ContactResultSet _userFiltered;
        public Domain.Aggregates.ValueObjects.PieceOfEquipmentResultSet _pieceOfEquipmentFiltered;
        ...
        public CalibrationSaaS.Infraestructure.Blazor.Pages.AssetsBasics.WorkOrderDetail_Search WorkOrderDetailSearch 
            = new CalibrationSaaS.Infraestructure.Blazor.Pages.AssetsBasics.WorkOrderDetail_Search();
...
#pragma warning restore CS1998 // El m�todo asincr�nico carece de operadores "await" y se ejecutar� de forma sincr�nica. Puede usar el operador 'await' para esperar llamadas API que no sean de bloqueo o 'await Task.Run(...)' para hacer tareas enlazadas a la CPU en un subproceso en segundo plano.
        ...
        public async Task ShowModalPoECreate()
        {
            ...
            Domain.Aggregates.Entities.Customer customer = new Domain.Aggregates.Entities.Customer()
            {
           ...
           ;
            ...
            var messageForm = Modal.Show<PieceOfEquipment_Create>("Piece of Equipment", parameters);
        ...
        [Inject] public Func<dynamic, Application.Services.IPieceOfEquipmentService<CallContext>> _poeServices { get; set; }
        ...
        public async Task ShowModalPoEDueDate()
        {
            ...
            {
                await ShowToast("Not  Test Code selected",ToastLevel.Info);
                //return;
            }
            ...
            var messageForm =  Modal.Show<POEWO_Search>("Piece Of Equipment", parameters, op);
        ...
        public async Task CustomerChange(string customerId)
        {
            ...
            if (Client != null)
            {
                ...
                try
                {
                    ...
                    Domain.Aggregates.Entities.Customer _custId = new Domain.Aggregates.Entities.Customer();
