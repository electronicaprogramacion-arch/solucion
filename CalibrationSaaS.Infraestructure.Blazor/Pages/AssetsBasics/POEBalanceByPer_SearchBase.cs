...
{
    public class POEBalanceByPer_SearchBase : Base_Create<PieceOfEquipment, Application.Services.IPieceOfEquipmentService<CallContext>, Domain.Aggregates.Shared.AppStateCompany>
    ...
    //Application.Services.IBasicsServices, Domain.Aggregates.Shared.Basic.AppState>
    {
        ...
        public override async Task<ResultSet<PieceOfEquipment>> LoadData(Pagination<PieceOfEquipment> pag)
        {
            ...
            poe.PieceOfEquipmentID = PieceOfEquipmentID;
            ...
            Eq = (await _poeGrpc.GetPieceOfEquipmentBalanceByPer(pag));
...
#pragma warning disable CS0108 // 'POEBalance_SearchBase.Dispose()' oculta el miembro heredado 'Base_Create<PieceOfEquipment, IPieceOfEquipmentService<CallContext>, AppStateCompany>.Dispose()'. Use la palabra clave new si su intenci�n era ocultarlo.
        public void Dispose()
#pragma warning restore CS0108 // 'POEBalance_SearchBase.Dispose()' oculta el miembro heredado 'Base_Create<PieceOfEquipment, IPieceOfEquipmentService<CallContext>, AppStateCompany>.Dispose()'. Use la palabra clave new si su intenci�n era ocultarlo.
        {
