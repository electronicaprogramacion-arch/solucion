...
{
    public class PieceOfEquipmen_CreateBase : Base_Create<PieceOfEquipment, Func<dynamic, Application.Services.IPieceOfEquipmentService<CallContext>>, Domain.Aggregates.Shared.Basic.AppState>
    {
        ...
        public PieceOfEquipment_SearchChildren Children { get; set; }
        ...
        [Inject] public Func<dynamic, Application.Services.IWorkOrderDetailServices<CallContext>> WODServices { get; set; }
        ...
        [Inject] public Func<dynamic, Application.Services.IAssetsServices<CallContext>> _assetsServices { get; set; }

        [Inject] public Func<dynamic, CalibrationSaaS.Application.Services.IBasicsServices<CallContext>> _basicsServices { get; set; }

        [Inject] public Func<dynamic, Application.Services.ICustomerService<CallContext>> _customerServices { get; set; }
        ...
        public CalibrationSaaS.Infraestructure.Blazor.Pages.AssetsBasics.WorkOrderDetailHist_Search WorkOrderDetailSearch { get; set; } = new CalibrationSaaS.Infraestructure.Blazor.Pages.AssetsBasics.WorkOrderDetailHist_Search();
        ...
        public async Task LoadET(EquipmentTemplate ET)
        {
            ...
            if (EquipmentTypeObject.IsBalanceAndScale == true)  /// (eq.EquipmentTemplate.EquipmentTypeGroupID == 57)////EquipmentTypeObject.HasWorkOrderDetail && eq.EquipmentTemplate.EquipmentTypeObject.IsBalance)
            {
                IsScale = true;
            }
            else
        ...
        public async Task ShowModalReport()
        {
            ...
            var messageForm = Modal.Show<CalibrationSaaS.Infraestructure.Blazor.DynamicReport>("Report", parameters, op);
            var result = await messageForm.Result;
...
#pragma warning restore CS1998
        ...
        //[Inject]
        //public Application.Services.IBasicsServices<CallContext> Basics { get; set; }
        ...
        public async Task ShowModal()
        {
            ...
            var messageForm = Modal.Show<Equipment_Search>("Select Equipment Template", parameters,op);
            var result = await messageForm.Result;
        ...
        public async Task ShowModalPoEChildren()
        {
            ...
            var messageForm = Modal.Show<POEChildren_Search>("Piece Of Equipment", parameters, op);
