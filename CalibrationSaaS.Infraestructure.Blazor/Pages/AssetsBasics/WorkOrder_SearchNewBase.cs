...
{
    public class WorkOrder_SearchNewBase : Base_Create<WorkOrder, Func<dynamic, Application.Services.IAssetsServices<CallContext>>, Domain.Aggregates.Shared.AppStateCompany>
...
#pragma warning restore CS0108 // 'WorkOrder_SearchNewBase.Logger' oculta el miembro heredado 'KavokuComponentBase<WorkOrder>.Logger'. Use la palabra clave new si su intención era ocultarlo.
        ...
        public List<Domain.Aggregates.Entities.WorkOrder> List = new List<Domain.Aggregates.Entities.WorkOrder>();
        ...
        public ResponsiveTable<Domain.Aggregates.Entities.WorkOrder> Grid { get; set; } = new ResponsiveTable<Domain.Aggregates.Entities.WorkOrder>();
